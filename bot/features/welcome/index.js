/**
 * Простая приветственная фича: /start -> длинный привет + одна кнопка "Оформить подписку на 30 дней — 790 ₽".
 * Кнопка ведёт на внешний URL оплаты (страница /pay).
 * Текст содержит ссылку на оферту (из OFFER_URL).
 */
...
function buildWelcomeText(env) {
  ...
  return [
    ...
    '',
    '💳 Стоимость курса: <b>790 руб.</b>',
    '⏳ Длительность: <b>30 дней</b>.',
    '',
    'Если ты готов сделать первый шаг — жми «Оформить подписку на 30 дней — 790 ₽» прямо сейчас.',
    '',
    'Продолжая пользоваться ботом, вы соглашаетесь с <a href="' + offer + '">условиями оферты</a>.',
    '',
    ...
    try {
      await ctx.reply(text, {
        ...
        ...Markup.inlineKeyboard([
          [Markup.button.callback('Оформить подписку на 30 дней — 790 ₽', 'yk:sub:790')]
        ])
      });
